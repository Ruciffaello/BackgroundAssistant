...
本文件是專案總覽與文件入口。詳細工作狀態統一記錄於 [TASKS.md](docs/zh/project/TASKS.md)。
...
- 依 [BM25 測試情境](docs/zh/testing/BM25_TEST_SCENARIOS.md)驗證路由與上下文過濾。
...
- **說明文件導覽入口**：[docs/README.md](docs/README.md)
- **繁體中文說明文件**：[docs/zh/README.md](docs/zh/README.md)
- **English Documentation**：[docs/en/README.md](docs/en/README.md)

| 文件 | 用途 |
| --- | --- |
| [TASKS.md](docs/zh/project/TASKS.md) | 工作狀態唯一來源 |
| [DECISIONS.md](docs/zh/project/DECISIONS.md) | 重要架構決策 |
| [PARSER_REDESIGN.md](docs/zh/design/PARSER_REDESIGN.md) | 現行 Router 規格 |
| [USER_MEMORY_DESIGN.md](docs/zh/design/USER_MEMORY_DESIGN.md) | 對話資料與未來記憶邊界 |
| [HANDOFF.md](docs/zh/project/HANDOFF.md) | 最近一次開發交接紀錄 |
| [BM25_TEST_SCENARIOS.md](docs/zh/testing/BM25_TEST_SCENARIOS.md) | Router 與 BM25 人工測試劇本 |
| [TEST_GUIDE.md](docs/zh/testing/TEST_GUIDE.md) | 一般人工測試方式 |
